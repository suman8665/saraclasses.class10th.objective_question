...
public class UrlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ads_manager.loadbannerads(layout, UrlActivity.this);
        ...
        webView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                Toast.makeText(UrlActivity.this, "Thanks For Using This Application", Toast.LENGTH_SHORT).show();
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
                ...
                // Toast.makeText(UrlActivity.this, consoleMessage.message(), Toast.LENGTH_SHORT).show();
                ...
                if (tab.equals("true")) {
                    ...
                    tab = "false";
                    customtab_manager.open_tab(UrlActivity.this, consoleMessage.message());
                ...
                if (consoleMessage.message().equals("ads")) {
                    ...
                    ads_manager.show_intads_with_callback(UrlActivity.this);
